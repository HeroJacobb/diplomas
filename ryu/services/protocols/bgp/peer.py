...
#         self.state.bgp_state = self._protocol.state
    ...
    def _handle_update_msg(self, update_msg):
        ...
        # CHANGED
        #print("update_msg.get_total_path_attribute_len"+update_msg.get_total_path_attribute_len)
        if update_msg.get_total_path_attribute_len() == 0 and update_msg.get_withdrawn_routes_len() == 0:
           ...
           # print update_msg.nlri
           # print "++++"
           # x.send_event_to_observers(SDNiUpdate(update_msg.nlri))

           # Peer.ddos_ip=update_msg.nlri
           # self.outgoing_msg_event
            return
            # CHANGED
