...
from ryu.lib.packet.bgp import BGPOptParamCapabilityEnableUri
...
from ryu.services.protocols.bgp.rtconf.base import ENABLE_URI
...
class NeighborConf(ConfWithId, ConfWithStats):
    ...
    OPTIONAL_SETTINGS = frozenset([CAP_REFRESH,
                                   ...
                                   CAP_MBGP_VPNV4, CAP_MBGP_VPNV6,ENABLE_URI, #CHANGED
